...
def find_from_testlink(GetFromPDF_list):
    ...
    for a, Document_ID in enumerate(GetFromPDF_list):
        ...
        if Document_ID and Document_ID != '':
            ...
            # print(check_ID_text(driver))
            time.sleep(2)
            # print(check_ID_text(driver))
            if check_ID_text_14(driver) == True or check_ID_text_20(driver) == True:
                if check_ID_text_14(driver):
                ...
                elif check_ID_text_20(driver) == True:
                    ID_text = WebDriverWait(driver, timeout).until(EC.presence_of_element_located((By.XPATH, '//*[@id="ext-gen20"]/li/div/a/span')))
                ...
                if (Document_ID.strip()) in ID_text.text:
                    ...
                    Document_ID_list.append('')
                    print(f'{Document_ID} 與 {ID_text} 不同')
    ...
    # print(len(Document_ID_list), len(Different_Locations))  
...
def check_ID_text_20(driver):
    try:
        driver.find_element(By.XPATH, '//*[@id="ext-gen20"]/li/div/a/span')
        return True
    except:
        return False
